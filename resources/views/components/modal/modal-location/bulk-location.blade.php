    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-2xl shadow-xl border border-slate-200">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-2 text-lg font-bold text-slate-900">Hapus Lokasi Terpilih?</h3>
                <p class="mb-6 text-sm text-slate-500">Anda akan menghapus <span id="bulk-count" class="font-bold text-slate-900">0</span> lokasi yang dipilih. Tindakan ini tidak dapat dibatalkan.</p>
                
                <form id="bulk-delete-form" action="{{ route('admin.locations.bulkDestroy') }}" method="POST" class="flex items-center justify-center gap-3">
                    @csrf
                    @method('DELETE')
